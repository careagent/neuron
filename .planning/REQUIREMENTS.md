...
- [x] **ROUT-02**: Connection authentication pipeline: consent token → relationship check → route
...
- [x] **ROUT-05**: Graceful session termination from either side with cleanup
